...
const translations = {
    en: {
        ...
        recruiter_prog_value: "AI & Software Engineering",
        recruiter_year_label: "Year",
        recruiter_year_value: "3rd year in AI",
    ...
    fr: {
        ...
        recruiter_year_value: "3ème année en IA",
        ...
        about_p1: "En tant qu’étudiant en troisième année en IA cycle d’ingénierie à l’UEMF, je dispose d’une solide base en apprentissage automatique et d’un fort intérêt pour le développement d’applications de bout en bout. Je travaille principalement avec Python, Java et C++, et je suis motivé à connecter des modèles intelligents à des systèmes backend et à des architectures full-stack modernes afin de créer des solutions pratiques et évolutives.",
        ...
        contact_internship: "Je recherche un stage d’un mois à partir de juillet 2026. Je suis étudiant en troisième année du cycle d’ingénieur en IA à l’UEMF, avec une solide formation en apprentissage automatique et une maîtrise de Python, Java et C++. Je m’intéresse particulièrement au développement d’applications de bout en bout, à la gestion et à l’analyse de données, ainsi qu’à l’intégration de modèles intelligents dans des solutions concrètes et pratiques.",
